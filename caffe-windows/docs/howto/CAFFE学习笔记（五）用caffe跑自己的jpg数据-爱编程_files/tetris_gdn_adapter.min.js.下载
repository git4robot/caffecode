...
["",""])[1],videoUrl:b,image:a("tetris-assets-card"+h+"Video-image")},g);for(var d=[],e="tetris-assets-card"+h+"ImageGallery",b=0;10>b;b++)p({"@type":"ImageGalleryImage",image:a(e+"-image"+b+"-image"),title:a(e+"-image"+b+"-title"),text:a(e+"-image"+b+"-text"),cta:a(e+"-image"+b+"-cta"),href:a(e+"-image"+b+"-href")},d);p({"@type":"ImageGalleryAsset",images:d},g);if("true"==a("tetris-assets-card"+h+"ProductGallery-insert")){d=[];e="tetris-assets-cardXProductGallery";for(b=0;30>b;b++)p({"@type":"ProductGalleryProduct",
